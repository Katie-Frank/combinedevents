...
**combinedevents** is not yet released on [CRAN](https://CRAN.R-project.org) but should be soon as I submitted it to CRAN on September 17th. In the meantime, you can install the development version from [GitHub](https://github.com/) with:
